...
Description : Types Haskell générés depuis le WSDL CommandeHistoriqueDonneesMesuresFines v1.0
...
elementDemandePublicationMesuresFines = parseSchemaType "demandePublicationMesuresFines"
