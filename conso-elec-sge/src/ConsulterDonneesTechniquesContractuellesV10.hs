...
module ConsulterDonneesTechniquesContractuellesV10
  ( module ConsulterDonneesTechniquesContractuellesV10
  ) where
...
elementToXMLConsulterDonneesTechniquesContractuelles = schemaTypeToXML "consulterDonneesTechniquesContractuelles"
