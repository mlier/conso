...
manquantes sont appliquées (voir "Conso.Fr.Site.SiteDB.Elec.Storage.Migration").
-}
module Conso.Fr.Site.SiteDB.Elec.Storage.Connection
  ( siteDbPath
  , openSiteDb
...
import           Conso.Fr.Site.Types                              (SiteId(..))
import           Conso.Fr.Site.SiteDB.Elec.Storage.Schema         (ensureSchema)
import           Conso.Fr.Site.SiteDB.Gaz.Storage.Migration       (ensureGazSchema)
