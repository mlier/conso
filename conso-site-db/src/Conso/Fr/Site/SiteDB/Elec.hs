{-|
Module      : Conso.Fr.Site.SiteDB.Elec
...
de l'UUID depuis le registre central ("Conso.Fr.Site.Registry").
-}
module Conso.Fr.Site.SiteDB.Elec
  ( -- * Types communs
  ...
  , module Conso.Fr.Site.SiteDB.Elec.Storage.Connection
    -- * Requêtes
  , module Conso.Fr.Site.SiteDB.Elec.Storage.Query
    -- * Ingestion par batch
...
import Conso.Fr.Site.SiteDB.Elec.Storage.Connection
import Conso.Fr.Site.SiteDB.Elec.Storage.Query
import Conso.Fr.Site.SiteDB.Elec.Ingestion.Batch
