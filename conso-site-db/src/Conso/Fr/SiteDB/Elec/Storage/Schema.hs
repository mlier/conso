{-|
Module      : Conso.Fr.SiteDB.Elec.Storage.Schema
...
"Conso.Fr.SiteDB.Elec.Storage.Migration". Il sert de point d'accès stable
...
import Conso.Fr.SiteDB.Elec.Storage.Migration (ensureSchema, currentSchemaVersion)
