...
{-|
Module      : Conso.Fr.SiteDB.Elec.Ingestion.FromRfiles
...
import           Conso.Fr.SiteDB.Elec.Types.Common            (PrmId(..))
import           Conso.Fr.SiteDB.Elec.Types.Header            (CodeFlux, codeFluxFromText)
import           Conso.Fr.SiteDB.Elec.Ingestion.Batch         (ingestFile, IngestResult(..))
